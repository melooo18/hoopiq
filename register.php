        ...
        <div class="col-md-5">
            <div class="card bg-secondary border-0 shadow-lg text-light">
                <div class="card-body p-5">
                    ...
                    <?php if ($success): ?>
                        <div class="alert alert-success"><?= htmlspecialchars($success) ?> <a href="index.php" class="alert-link">Login</a></div>
                    <?php endif; ?>
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="password" class="form-control bg-dark text-light border-0" id="confirm_password" name="confirm_password" required>
                        </div>
                        <button type="submit" class="btn btn-warning w-100 fw-bold">Register</button>
                    </form>

                    <div class="mt-3 text-center">
                        <p class="mb-0">Already have an account? <a href="index.php" class="text-warning text-decoration-none">Login here</a></p>
                    </div>
                </div>
            </div>
        </div>
